...
CREATE TABLE `orders`  (
                           ...
                           `trade_status` tinyint(1) NULL DEFAULT NULL COMMENT '交易状态 0:未完成 1:已完成',
                           `trade_time` datetime NULL DEFAULT NULL COMMENT '交易时间',
                           `refund_status` tinyint(1) NULL DEFAULT NULL COMMENT '退款状态 0:未退款 1:已退款',
                           `refund_time` datetime NULL DEFAULT NULL COMMENT '退款时间',
                           `is_refund_confirm` tinyint(1) NULL DEFAULT NULL COMMENT '退款是否已经确认',
                           `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                           PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `product`  (
                            ...
                            `old_level` int(2) NULL DEFAULT NULL COMMENT '新旧程度 1-10',
                            ...
                            `is_bargain` tinyint(1) NULL DEFAULT NULL COMMENT '是否支持砍价 0:否 1:是',
                            `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
                            PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `user`  (
                         ...
                         `user_pwd` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户密码 MD5加密',
